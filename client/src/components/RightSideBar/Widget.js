...
import comment from "../../assetes/assets/comment-alt-solid.svg";
import pen from "../../assetes/assets/pen-solid.svg";
import blacklogo from "../../assetes/assets/blacklogo.svg";
function Widget() {
  return (
    <div className="widget">
      ...
      <div className="right-sidebar-div-1">
        ...
        <div className="right-sidebar-div-2">
          <img src={blacklogo} alt="blogo" width="18"></img>
          <p>
